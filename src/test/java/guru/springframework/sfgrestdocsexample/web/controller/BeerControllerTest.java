        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("createdDate").description("Date Crated"),
                                fieldWithPath("lastModifiedDate").description("Date Updated"),
                                fieldWithPath("beerName").description("beer Name"),
                                fieldWithPath("beerStyle").description("beerStyle"),
                                fieldWithPath("upc").description("UPC of"),
                                fieldWithPath("price").description("Price of"),
                                fieldWithPath("quantityOnHand").description("Quantinty On Hand")
